...
This is a fork of Jonathan Viney's acts_as_taggable_on_steroids (thanks for the great work!), adding support for single table inheritance (STI) and permalinks. The original version can be found here https://github.com/jviney/acts_as_taggable_on_steroids
...
Rails 2.*
  ...
  ruby script/plugin install git://github.com/paceline/acts_as_taggable_on_steroids.git

Rails 3:

  rails plugin install git://github.com/paceline/acts_as_taggable_on_steroids.git
